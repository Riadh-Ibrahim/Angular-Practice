...
export class CvService {
  ...
  public cvs: Cv[] = [
    new Cv(0, "Ibrahim", "Riadh", 22, 11111111, "Student", "assets/images/rotating_card_profile.png"),
    new Cv(1, "Grami", "Aya", 2221, 22222222, "Student", "assets/images/rotating_card_profile2.png"),
    new Cv(2, "Bouhari", "Fatma", 2223, 33333333, "Student", "assets/images/rotating_card_profile3.png"),
    new Cv(2, "Bouden", "Youssef", 2223, 33333333, "Student", "assets/images/rotating_card_profile3.png"),
  ];

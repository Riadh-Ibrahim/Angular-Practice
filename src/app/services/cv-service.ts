...
export class CvService {
  ...
  public cvs: Cv[] = [
    new Cv(0, "Ibrahim", "Riadh", 22, 11111111, "Student", "assets/images/Riadh.jpg"),
    ...
    new Cv(3, "Bouden", "Youssef", 2223, 33333333, "Student", "assets/images/rotating_card_profile3.png"),
  ];
